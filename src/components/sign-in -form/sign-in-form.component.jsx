        ...
        <div className="sign-up-container">
            ...
            <form onSubmit={handleSubmit}>               
                ...
                <div className="buttons-container">
                    ...
                    <Button type='button' buttonType={BUTTON_TYPE_CLASSES.google} onClick = {singInWithGoogle}>Google sing in</Button> {/*By default buttons are type "submit" wjhen inside froms - you need to specified another type*/}
                </div>                
            </form>
        </div>
    );
